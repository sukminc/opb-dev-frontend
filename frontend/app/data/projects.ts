...
export const projects: Project[] = [
  ...
  {
    slug: "one-percent-better-focus",
    repoName: "one-percent-better-focus",
    title: "One Percent Better Focus",
    tagline: "New project — details coming soon",
  ...
  {
    slug: "one-percent-better-poker-staking",
    repoName: "one-percent-better-poker-staking",
    title: "One Percent Better Poker Staking",
    tagline: "Mobile-first poker staking agreement platform with tamper-evident receipts",
    description: "Mobile-first poker staking agreement platform with tamper-evident receipts",
    status: "building",
    tags: [],
  ...
  {
    slug: "action-keeper-web",
    repoName: "action-keeper-web",
    title: "Action Keeper Web",
    tagline: "Trust, transparency, and simplicity for poker staking agreements",
    description: "Trust, transparency, and simplicity for poker staking agreements",
    status: "building",
    tags: [],
    url: "https://github.com/sukminc/action-keeper-web",
    featured: false,
    seed: 67,
    mvpProgress: 10,
  },
  {
    slug: "mypokerstats",
    repoName: "MyPokerStats",
    title: "My Poker Stats",
    tagline: "Automated hand history analysis that surfaces strategic leaks and strengths",
    description: "Automated hand history analysis that surfaces strategic leaks and strengths",
    status: "building",
    tags: [],
    url: "https://github.com/sukminc/MyPokerStats",
    featured: false,
    seed: 82,
    mvpProgress: 10,
  },
  {
    slug: "payments-ledger-etl",
    repoName: "payments-ledger-etl",
    title: "Payments Ledger ETL",
    tagline: "Portfolio-ready double-entry accounting ETL demonstrating Python + SQL engineering",
    description: "Portfolio-ready double-entry accounting ETL demonstrating Python + SQL engineering",
    status: "building",
    tags: [],
    url: "https://github.com/sukminc/payments-ledger-etl",
    featured: false,
    seed: 15,
    mvpProgress: 10,
  },
  {
    slug: "sports-odds-etl",
    repoName: "sports_odds_etl",
    title: "Sports Odds ETL",
    tagline: "GCP-deployed ETL pipeline extracting NFL betting odds to track line movements",
    description: "GCP-deployed ETL pipeline extracting NFL betting odds to track line movements",
    status: "building",
    tags: [],
    url: "https://github.com/sukminc/sports_odds_etl",
    featured: false,
    seed: 55,
    mvpProgress: 10,
  },
